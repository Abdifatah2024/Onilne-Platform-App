        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          <div className="p-8">
            ...
            <form className="space-y-4" onSubmit={handleFormSubmit}>
              ...
              <button
                type="submit"
                className="w-full bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 focus:ring-offset-2"
              >
                Send Message
              </button>
            </form>
